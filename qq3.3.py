...
class Level(object):
    ...
    def is_blocking(self, x, y):
        ...
        #if(x == house.pos and y==house.pos) return False
...
class Game(object):
    ...
    def use_level(self, level):
        ...
        for pos, tile in level.items.items():
            ...
            if tile.get("player") in ('true', '1', 'yes', 'on'):
                ...
                if(tile.get('name') == 'house'):
                    print ('house at '+ str(sprite.pos))
                    self.house = sprite
    ...
    def main(self):
        """Run the main loop."""
        self.walk_path = [] # [0,1,1,0,0,1,0,0,0,0,3,0,0,0,0,3,3,2]
        ...
        while not self.game_over:
            ...
            for event in pygame.event.get():
                if event.type == pg.QUIT:
                    ...
                    # find path
                    self.Solver = solver.Star(self.player.pos, self.house.pos, "rook", self.barriers)
                    ...
                    if self.Solver.solution == "NO SOLUTION":
                        ...
                        print("solution =", self.Solver.solution)
                        #self.walk_path = [0] # from self.Solver.
                    #for i in self.Solver.solution:
                    print("player AT", self.player.pos)
                    print(self.Solver.solution.pop())
...
screen = (15 * MAP_TILE_WIDTH, 15 * MAP_TILE_HEIGHT )
...
if __name__ == "__main__":
    ...
    pygame.init()
    pygame.display.set_mode(screen) #((424, 320))
    Game().main()
